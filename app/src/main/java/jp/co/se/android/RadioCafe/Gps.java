...
/**
 * Created by Administrator on 14/03/19.
 */
public class Gps extends Activity {
    ...
    //public static final String YOUTUBE_URL = "http://www.youtube.com/user/FM797RADIOCAFE";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //ロケーションリスナーを設定
        locationManager.requestLocationUpdates(provider,/*LocationManager.NETWORK_PROVIDER*/
    ...
    private void showLocation(final Location location) {
        ...
        if (location != null) {
            sb.append(Latitude); //緯度
            sb.append(Longitude); //経度
        ...
        web.loadUrl(URL + Latitude + "," + Longitude);
    }
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (providers.indexOf("network", 0) < 0) {
                                ...
                                Intent intent6 = new Intent(getActivity(), Gps.class);
                                intent6.putExtra("URL", STATION_URL.toString());
