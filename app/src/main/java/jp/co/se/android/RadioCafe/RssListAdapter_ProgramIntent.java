...
/**
 * Created by Adminstrator on 2014/12/03.
 */
public class RssListAdapter_ProgramIntent extends ArrayAdapter<Item> {
    ...
    public RssListAdapter_ProgramIntent(Context context, List<Item> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = mInflater.inflate(R.layout.item_row3, null);
        }
