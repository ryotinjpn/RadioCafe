 ...
 */
public class TopicsIntent extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RssListAdapter_Topics(this, mItems);

        // タスクを起動する
        RssParserTask_TopicsIntent task = new RssParserTask_TopicsIntent(this, mAdapter);
        task.execute(URL);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) { // if使うとエラー（itemがInt形式なため）
            ...
            case R.id.reload:
                ...
                final String URL = intent.getStringExtra("URL");
                final String TITTLE = intent.getStringExtra("TITTLE");
                Intent intent14 = new Intent(this, TopicsIntent.class);
