...
/**
 * Created by Adminstrator on 2014/10/01.
 */
public class Description extends Activity {
    ...
    public static final String Comiradi_URL = "http://comiradi.jp/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        textView = (TextView) findViewById(R.id.textview_description1);
        textView = (TextView) findViewById(R.id.textview_description2);
        textView = (TextView) findViewById(R.id.textview_description3);
        textView = (TextView) findViewById(R.id.textview_description4);
    ...
    public void Comiradi(View view) {
        Intent intent = new Intent(getApplication(), Webview.class);
        intent.putExtra("URL",  Comiradi_URL.toString());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) { // if使うとエラー（itemがInt形式なため）
            ...
            case R.id.mail:
                ...
                return true;
            case R.id.reload:
                Intent intent14 = new Intent(this, Description.class);
